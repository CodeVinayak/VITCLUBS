...
<body>
        ...
        <div class="dropdown-box-list" data-simplebar>
          ...
          <div class="dropdown-box-list-item">
            <div class="user-status notification">
              ...
              <p class="user-status-title"><a class="bold" href="#">Vinayak Singh</a> posted a comment
                on your <a class="highlighted" href="profile-photos.html">photo</a></p>
          ...
          <div class="dropdown-box-list-item">
            <div class="user-status notification">
              ...
              <p class="user-status-title"><a class="bold" href="#">Kanika Bisht</a> posted a comment
                on your <a class="highlighted" href="#">post</a></p>
  ...
  <div class="content-grid">
    <div class="section-banner">
      ...
      <p class="section-banner-text">Browse all the VIT Club members of the Community!</p>
    </div>
      ...
      <div class="section-filters-bar-actions">
        ...
        <div class="filter-tabs">
          <div class="filter-tab active">
            <p class="filter-tab-text">Recommended</p>
          </div>
