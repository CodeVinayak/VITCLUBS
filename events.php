...
<body>
      ...
      <nav class="navigation">
        ...
        <ul class="menu-main">
          ...
          <li class="menu-main-item">
            <!-- MENU MAIN ITEM LINK -->
            <a class="menu-main-item-link" href="home.html">Home</a>
            <!-- /MENU MAIN ITEM LINK -->
          </li>
          <!-- /MENU MAIN ITEM -->
      ...
      <div class="form-row">
        <div class="form-item split join-on-mobile medium">
          <div class="form-select">
            ...
            <select id="event-time-end" name="event_time-end">
              <option value="1">1:00</option>
              <option value="2">2:00</option>
              <option value="3">3:00</option>
              <option value="4">4:00</option>
          ...
          <div class="form-select">
            <label for="event-time-annotation-end">AM - PM</label>
            <select id="event-time-annotation-end" name="event_time-annotation-end">
              <option value="0">PM</option>
              <option value="1">AM</option>
            </select>
            <svg class="form-select-icon icon-small-arrow">
        ...
        <div class="form-item">
          <div class="form-input-decorated">
            <div class="form-input small">
              ...
              <input type="file" accept="image/png,image/jpeg" id="event-cover-photo" name="event_cover_photo">
            </div>
  ...
  if (isset($_POST["Create_event"])) {
    ...
    $s_time = mysqli_real_escape_string($conn,$_POST['event_time-start'] . " " . $_POST['event_time-annotation']);
    $e_time = mysqli_real_escape_string($conn,$_POST['event_time-end'] . " " . $_POST['event_time-annotation-end']);
    $desc = mysqli_real_escape_string($conn,$_POST['event_description']);
    $tmpimg = $_FILES['event_cover_photo']['tmp_name'];
    $imgname = $_FILES['event_cover_photo']['name'];
    $sql = "INSERT INTO `event`(`category`, `name`, `location`, `date`, `start_time`, `end_time`, `description`, `e_pic`) VALUES ('$cat','$name','$loc','$date','$s_time','$e_time',$desc','$imgname')";
