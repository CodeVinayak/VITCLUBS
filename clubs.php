...
<head>
    ...
    <title>VIT CLUBS | All Clubs</title>
</head>
<body>
    ...
    <div class="content-grid">
        <div class="section-banner">
            ...
            <p class="section-banner-text">Browse all the VIT clubs of the community!</p>
        </div>
            ...
            <div class="user-preview">
                ...
                <div class="user-preview-info">
                    ...
                    <div class="user-short-description">
                        ...
                        <p class="user-short-description-title"><a href="club-timeline.php">Cosplayers of the World</a>
                        </p>
            ...
            <div class="user-preview">
                ...
                <div class="user-preview-info">
                    ...
                    <div class="user-short-description">
                        ...
                        <p class="user-short-description-title"><a href="club-timeline.php">Twitch Streamers</a></p>
